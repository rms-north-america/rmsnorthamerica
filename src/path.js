...
export const REMOTE_ASSISTANCE = 'http://remote.rms.com.au/';

// Contact
export const CONTACT_AUSTRALIA_ASIA = '/australia-asia';
export const CONTACT_NEW_ZEALAND = '/new-zealand';
export const CONTACT_INDIA = '/india';
export const CONTACT_MIDDLE_EAST = '/middle-east';
export const CONTACT_UK_IRELAND = '/uk-ireland';
...
export const PRODUCT_SUPPORT = '/support';

// Industry
export const INDUSTRY_HOTEL = '/hotel';
export const INDUSTRY_RV_PARK = '/rv-park';
export const INDUSTRY_CAMPGROUND = '/campground';
